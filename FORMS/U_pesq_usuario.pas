...
begin
  ...
  if Frm_pesq_usuario.frxReport1.LoadFromFile(caminho + 'REL_USUARIO.fr3') then
  begin
...
begin
  ...
  Q_pesq_padrao.sql.add('SELECT USER_ID, NAME, TYPE, SIGNIN FROM USUARIO');
  // add sql
  ...
  case cb_chave_pesquisa.ItemIndex of
    0:
      begin
        ...
        Q_pesq_padrao.paramByname('PUSER_ID').AsString := ed_nome.Text;
    ...
    1:
      begin
        ...
        Q_pesq_padrao.paramByname('PNAME').AsString := '%' + ed_nome.Text + '%';
        // aponta para o campo do parametro
      end;
    2:
      begin
        ...
        Q_pesq_padrao.paramByname('PSIGNIN').AsDate :=

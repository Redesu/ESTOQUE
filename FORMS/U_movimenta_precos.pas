...
type
  TFrm_movimenta_precos = class(TForm)
    ...
    procedure rg_alteraClick(Sender: TObject);
    procedure bt_acaoExit(Sender: TObject);
  private
...
begin
  ...
  Q_produto.Close;
  Q_produto.Open;
  MessageDlg('Alteração feita com sucesso!', mtInformation, [mbOk], 0);
end;
...
procedure TFrm_movimenta_precos.rg_alteraClick(Sender: TObject);
begin
  case rg_altera.ItemIndex of
